...
```shell
nix flake init --template github:nixfemby/dev-templates-aux#${ENV}
```
...
nix flake init --template github:nixfemby/dev-templates-aux#rust

# Create a new project
nix flake new --template github:nixfemby/dev-templates-aux#rust ${NEW_PROJECT_DIRECTORY}
```
